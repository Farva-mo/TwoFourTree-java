...
public class App {
    ...
    private static ArrayList<Integer> deDuplicateAndScramble(ArrayList<Integer>
                                                                     list) {
...
// Collections.shuffle(outList);
    ...
    private static ArrayList<Integer> generateIntArrayList(int howMany) {
        ...
        for(int i = 0; i < howMany; i++) {
            list.add(Integer.valueOf(RandomGenerator.nextInt(0,
                    1000000000)));
        }
        list = deDuplicateAndScramble(list);
        return list;
    }
    private static ArrayList<Integer> generateStrikeList(ArrayList<Integer>
                                                                 fromList, int howMany) {
    ...
    private static ArrayList<Integer> generateRemoveList(ArrayList<Integer>
                                                                 fromList) {
        ArrayList<Integer> removeList = new
                ArrayList<Integer>(fromList.size()/2);
    ...
    private static <T> int executeFinds(TwoFourTree coll, ArrayList<Integer>
            strikes) {
        boolean sentinel;
        int failures = 0;
...
// System.out.printf("\nFailed to find %d", e.intValue());
    ...
    private static <T> int executeComparisonFinds(TreeSet<Integer> coll,
...
// System.out.printf("\nFailed to find %d", e.intValue());
    ...
    public static void executeIntCase(int listSize, int strikeSize, boolean
            includeRemoves) {
